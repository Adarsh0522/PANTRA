...
// --- REUSABLE COLLAPSIBLE STEP COMPONENT (Identical to New PAN) ---
...
export function PanCorrectionContainer({ initialProfile }: { initialProfile?: any }) {
    ...
    const fetchPreview = async () => {
      ...
      try {
        const res = await fetch("/api/generate-pdf/preview", {
          ...
          body: JSON.stringify({ formData: debouncedValues, type: "correction" }),
        });
              ...
              >
                <div className="bg-white p-10 rounded-[40px] shadow-2xl flex flex-col items-center gap-6 border border-white/20 animate-in zoom-in-95 duration-500">
                  ...
                  <div className="space-y-1 text-center">
                    ...
                    <p className="text-sm font-medium text-slate-500">Verifying your form data...</p>
                  </div>
                </div>
              </motion.div>
            )}
              ...
              <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 py-6">
                ...
                >
                  ...
                  <div className="p-8 sm:p-12 text-center">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4 tracking-tight">Correction Ready</h2>
                    <p className="text-slate-500 mb-10 text-base leading-relaxed">
                      Your PAN correction form has been verified. Download or print your official PDF below.
                    </p>
