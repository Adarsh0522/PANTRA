export const PAN_CORRECTION_CONFIG: Record<string, any> = {
    page1: {
        ...
        correct_aadhaar:    { x: 27.3, y: 87.2,  type: 'checkbox', data_field: 'is_aadhaar_changed',    match: 'YES', width: 3.5, height: 3.5 },
        ...
        correct_name:    { x: 27.3, y: 66.7,  type: 'checkbox', data_field: 'is_name_changed',    match: 'YES', width: 3.5, height: 3.5 },
        ...
        correct_gender:    { x: 27.3, y: 106.7,  type: 'checkbox', data_field: 'is_gender_changed',    match: 'YES', width: 3.5, height: 3.5 },
        ...
        correct_dob: { x: 27.3, y: 111.4, type: 'checkbox', data_field: 'is_dob_changed', match: 'YES', width: 3.5, height: 3.5 },
        ...
        correct_address: { x: 27.3, y: 117.1, type: 'checkbox', data_field: 'is_address_changed', match: 'YES', width: 3.5, height: 3.5 },

        comm_residence: { x: 64.0,  y: 123.2, type: 'checkbox', data_field: 'comm_address', match: 'RESIDENCE', width: 3.5, height: 3.5 },
        comm_office:    { x: 93.0, y: 123.2, type: 'checkbox', data_field: 'comm_address', match: 'OFFICE',    width: 3.5, height: 3.5 },
        ...
        address_state:   { x: 47, y: 152.3, type: 'text', width: 28.5, height: 4.1 },
        address_pincode: { x: 159.8, y: 152.3, type: 'grid', boxes: 7,  box_width: 5.42, height: 4.1 },
        address_country: { x: 102.2,y: 152.3, type: 'text', width: 28, height: 4.1 },
        ...
        correct_contact: { x: 27.3, y: 172.2, type: 'checkbox', data_field: 'is_contact_changed', match: 'YES', width: 3.5, height: 3.5 },
        ...
        email:        { x: 98.5, y: 184.0, type: 'text', width: 99.5, height: 4.1, transform: 'none' },
        ...
        print_father: { x: 122.1, y: 242.3, type: 'checkbox', data_field: 'print_name', match: 'FATHER', width: 3.5, height: 3.5 },
        print_mother: { x: 146.3, y: 242.3, type: 'checkbox', data_field: 'print_name', match: 'MOTHER', width: 3.5, height: 3.5 },
    ...
    page2: {
        decl_name:       { x: 25, y: 18.4, type: 'text', width: 60, height: 3.0 },
        decl_capacity:   { x: 97.5,y: 18.4, type: 'text', width: 40,  height: 3.0 },
        decl_place:      { x: 26.5, y: 32.6, type: 'text', width: 60,  height: 3.0 },
        decl_date:       { x: 25.5, y: 41.4, type: 'text', width: 20, height: 3.0 },
    }
};
